...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://talentprofilemodule1.azurewebsites.net/profile/profile/getTalentProfile',
            headers: {
    ...
    saveProfile() {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentprofilemodule1.azurewebsites.net/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json',
            },
    ...
    render() {
        ...
        let imagepro = "https://talentprofilemodule1.azurewebsites.net/images/" +  this.state.profileData.profilePhoto 
        return (
                                    ...
                                    <div className="ui grid">
                                        ...
                                        >
                                            <PhotoUpload
                                                imageId={imagepro}
                                                updateProfileData={this.updateWithoutSave}
                                                savePhotoUrl={'https://talentprofilemodule1.azurewebsites.net/profile/profile/updateProfilePhoto'}
                                            />
                                        </FormItemWrapper>
